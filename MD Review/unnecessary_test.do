...
replace ai_pcv_test = 1 if regexm(ai_note, "(?i)anemia")
...
replace soap_pcv_test = 1 if regexm(soap_note, "(?i)anemia")
...
export excel "LLM_test_text_analysis.xlsx", replace firstrow(variables)
